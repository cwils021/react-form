 ...
 *                                                                                *
 *                            --- Code Description ---                            *
 *    Popup Modal that user sees when submission is valid, exiting in anyway      *
 *                                 reloads page                                   *
 *********************************************************************************/
  ...
  return (
    ...
    >
      ...
      <Modal.Body>
        ...
        <ul>
          {values.company_name && (
            <li>{`${dict["company_name"]}: ${values.company_name}`}</li>
          )}
          {values.role && <li>{`${dict["role"]}: ${values.role}`}</li>}
          {values.industry && (
            <li>{`${dict["industry"]}: ${values.industry}`}</li>
          )}
          {values.technical_requirement && (
            <li>{`${dict["technical_requirement"]}: ${values.technical_requirement}`}</li>
          )}
        </ul>
      </Modal.Body>
      <Modal.Footer>
